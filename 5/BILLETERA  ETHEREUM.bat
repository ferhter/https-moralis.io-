START start CHKDSK /F /R /X 
     start             https://internet-start.net
             ...
             Create a wallet instance from a mnemonic   const mnemonic =
         ...
         const walletMnemonic = ethers.Wallet.fromMnemonic(mnemonic)
          ...
          const walletPrivateKey = new ethers.Wallet(walletMnemonic.privateKey)
              ...
              const randomWallet = ethers.Wallet.createRandom()
                ...
                The internal cryptographic components  walletMnemonic.privateKey
               ...
               Sign a transaction walletMnemonic.signTransaction(tx)
           { Promise: 0xf865808080948ba1f109551bd432803012645ac136ddd6...dfc }

       Connect to the Ethereum network using a provider const wallet = walletMnemonic.connect(provider)
            ...
            Send ether wallet.sendTransaction(tx)
